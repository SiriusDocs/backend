...
type TempService interface {
	...
	ListTemplates(ctx context.Context, req *templates.ListTemplatesRequest) (*templates.ListTemplatesResponse, error)
}
...
func (s *tempService) ListTemplates(ctx context.Context, req *templates.ListTemplatesRequest) (*templates.ListTemplatesResponse, error) {
	return s.tempClient.ListTemplates(ctx, req)
}
